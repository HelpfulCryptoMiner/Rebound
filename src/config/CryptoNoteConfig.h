...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const uint64_t MONEY_SUPPLY                             =       UINT64_C(2000000000000000000); // 20 bil / 8 decimals
        ...
        const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX  =                    0x41efe139550; //buLLdoGe
        ...
        /* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
           You can get this value by doing "print_block 2" in NashCashd. It is used to know what timestamp
           to import from when the block height cannot be found in the node or the node is offline. */
        const uint64_t GENESIS_BLOCK_TIMESTAMP                       =                        1577033247;
        ...
        const uint64_t MAX_OUTPUT_SIZE_CLIENT                  =                 MONEY_SUPPLY /  1000000;
        ...
        const size_t   NORMAL_TX_MAX_OUTPUT_RATIO_V1_HEIGHT =                                                 3000000;
    ...
    const char     CRYPTONOTE_NAME[]           =              "BullDoge";
    const char     DATADIR_NAME[]              =              "bulldoge";
    ...
    const int      P2P_DEFAULT_PORT                          =            20001;
    const int      RPC_DEFAULT_PORT                          =            20005;
    const int      SERVICE_DEFAULT_PORT                      =            20010;
    ...
    const char        LATEST_VERSION_URL[] =     "https://github.com/Neodym8/BullDoge/releases/latest";
    const std::string LICENSE_URL          = "https://github.com/Neodym8/BullDoge/blob/development/LICENSE";

    const static boost::uuids::uuid CRYPTONOTE_NETWORK = {
        {
             0xb5, 0x0c, 0x4a, 0x5c, 0xcf, 0x55, 0x57, 0x42, 0x67, 0xf9, 0x91, 0xa4, 0xb5, 0xc1, 0x55, 0xe9  
        }
    };

    const char *const SEED_NODES[] = {
                "85.214.241.85:20001",              //strato
                "167.99.109.135:20001"
        };
} // namespace CryptoNote
