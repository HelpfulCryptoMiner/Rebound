...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "buLLdoGe";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "BDE";
    ...
    const std::string daemonName = "BullDoged";
